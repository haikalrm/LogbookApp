      ...
      searchInput.each(function () {
        ...
        searchInput.typeahead(
            ...
            // Pages
            {
              ...
              display: 'name',
              limit: 5,
              source: filterConfig(searchData.dashboard),
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Dashboard</h6>',
                ...
                notFound:
                  `<div class="not-found px-3 py-2">
                    <h6 class="suggestions-header text-primary mb-2">Dashboard</h6>
            ...
            // Files
            {
              ...
              display: 'name',
              limit: 4,
              source: filterConfig(searchData.logbook),
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Logbook</h6>',
                suggestion: function ({ url, icon, name }) {
                  return (
                    `<a href="${window.location.origin}/${url}">
                      <div>
                ...
                notFound:
                  `<div class="not-found px-3 py-2">
                    <h6 class="suggestions-header text-primary mb-2">Logbook</h6>
                    <p class="py-2 mb-0"><i class="ri-warning-line me-2 ri-14px"></i> No Results Found</p>
                  </div>`
              }
            },
            // Members
            {
              ...
              display: 'name',
              limit: 4,
              source: filterConfig(searchData.manage),
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Manage</h6>',
                suggestion: function ({ url, icon, name }) {
                  return (
                    `<a href="${window.location.origin}/${url}">
                      <div>
                ...
                notFound:
                  `<div class="not-found px-3 py-2">
                    <h6 class="suggestions-header text-primary mb-2">Manage</h6>
                    <p class="py-2 mb-0"><i class="ri-warning-line me-2 ri-14px"></i> No Results Found</p>
                  </div>`
              }
            },
            // Logout
            {
              ...
              display: 'name',
              limit: 4,
              source: filterConfig(searchData.logout),
              templates: {
                header: '<h6 class="suggestions-header text-primary mb-0 mx-3 mt-3 pb-2">Logout</h6>',
                suggestion: function ({ url, icon, name }) {
                  return (
                    `<a href="${window.location.origin}/${url}">
                      <div>
                ...
                notFound:
                  `<div class="not-found px-3 py-2">
                    <h6 class="suggestions-header text-primary mb-2">Logout</h6>
                    <p class="py-2 mb-0"><i class="ri-warning-line me-2 ri-14px"></i> No Results Found</p>
                  </div>`
              }
            }
          ...
          .bind('typeahead:select', function (ev, suggestion) {
            // Open selected page
            if (suggestion.url) {
              window.location = window.location.origin + "/" + suggestion.url;
            }
          })
          // On typeahead close
